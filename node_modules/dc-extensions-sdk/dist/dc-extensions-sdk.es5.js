    ...
    ContentLink.prototype.get = function (contentTypeIds) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.connection.request(CONTENT_LINK.CONTENT_GET, contentTypeIds, { timeout: false })];
            });
        });
    };
    return ContentLink;
    ...
    function ClientConnection(options) {
        ...
        if (_this.options.connectionTimeout !== false) {
            _this.connectionTimeout = window.setTimeout(function () {
                _this.handleMessage({ type: MESSAGE_TYPE.EMIT, event: MIO_EVENTS.CONNECTION_TIMEOUT });
    ...
    ContentReference.prototype.get = function (contentTypeIds) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.connection.request(CONTENT_REFERENCE.CONTENT_REF_GET, contentTypeIds, {
                        timeout: false
                    })];
            });
        });
...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.requestContext = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.connection.request(CONTEXT.GET)];
            });
        });
    };
    return SDK;
...
export { MediaLink, ContentLink, ContentItem, CONTEXT, CONTENT_ITEM, MEDIA_LINK, CONTENT_LINK, CONTENT_REFERENCE, FIELD, FORM, FRAME, Frame, Field, init, SDK };
