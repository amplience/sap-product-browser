...
var message_event_channel_1 = require("message-event-channel");
...
var SDK = /** @class */ (function () {
    ...
    function SDK(options) {
        ...
        this.connection = new message_event_channel_1.ClientConnection(this.options);
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            ...
                            this.connection.on(message_event_channel_1.MC_EVENTS.CONNECTED, function () { return __awaiter(_this, void 0, void 0, function () {
                                var e_1;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                            ...
                            this.connection.on(message_event_channel_1.MC_EVENTS.CONNECTION_TIMEOUT, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        this.contentItem = new ContentItem_1.ContentItem(this.connection);
    ...
    SDK.prototype.requestContext = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.connection.request(Events_1.CONTEXT.GET, null, { timeout: false })];
            });
        });
    };
    return SDK;
