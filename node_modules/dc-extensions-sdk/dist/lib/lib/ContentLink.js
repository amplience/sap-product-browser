        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!contentTypeIds || !Array.isArray(contentTypeIds) || !contentTypeIds.length) {
                    throw new Error(Errors_1.ERRORS_CONTENT_ITEM.NO_IDS);
                }
                return [2 /*return*/, this.connection.request(Events_1.CONTENT_LINK.CONTENT_GET, contentTypeIds, { timeout: false })];
            });
        });
    };
    return ContentLink;
