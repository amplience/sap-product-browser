(function (global, factory) {
	...
	***************************************************************************** */
	...
	})(exports.MIO_EVENTS || (exports.MIO_EVENTS = {}));
	/**
	...
	var Connection = /** @class */ (function () {
	    ...
	    Connection.prototype.setConnectionTimeout = function () {
	        ...
	        if (this.options.connectionTimeout !== false) {
	            this.connectionTimeout = window.setTimeout(function () {
	                ...
	                _this.handleMessage({
	                    type: exports.MESSAGE_TYPE.EMIT,
	                    event: exports.MIO_EVENTS.CONNECTION_TIMEOUT,
	    ...
	    Connection.prototype.finishInit = function () {
	        ...
	        this.emit(exports.MIO_EVENTS.CONNECTED);
	    ...
	    Connection.prototype.message = function (message) {
	        var force = false;
	        if (message.event === exports.MIO_EVENTS.HANDSHAKE ||
	            message.event === exports.MIO_EVENTS.CONNECTED ||
	            message.event === exports.MIO_EVENTS.DISCONNECTED) {
	            force = true;
	        }
	...
	var ServerConnection = /** @class */ (function (_super) {
	    ...
	    function ServerConnection(frame, options) {
	        ...
	        _this.on(exports.MIO_EVENTS.DISCONNECTED, function () { return (_this.connected = false); });
	        return _this;
	    }
	    ...
	    ServerConnection.prototype.listenForHandshake = function () {
	        var _this = this;
	        this.on(exports.MIO_EVENTS.HANDSHAKE, function (payload, resolve) {
	            _this.finishInit();
	            resolve(payload);
	        });
	    };
	...
	var ClientConnection = /** @class */ (function (_super) {
	    ...
	    function ClientConnection(options) {
	        ...
	        if (_this.options.connectionTimeout !== false) {
	            _this.connectionTimeout = window.setTimeout(function () {
	                _this.handleMessage({ type: exports.MESSAGE_TYPE.EMIT, event: exports.MIO_EVENTS.CONNECTION_TIMEOUT });
	    ...
	    ClientConnection.prototype.listenForHandshake = function () {
	        var _this = this;
	        this.request(exports.MIO_EVENTS.HANDSHAKE).then(function () {
	    ...
	    ClientConnection.prototype.addBeforeUnloadEvent = function () {
	        ...
	        this.options.window.addEventListener('beforeunload', function (event) {
	            _this.emit(exports.MIO_EVENTS.DISCONNECTED);
	        });
	    };
...
//# sourceMappingURL=message-io.umd.js.map
