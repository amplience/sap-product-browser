...
(function (FRAME) {
  ...
  FRAME["AUTO_RESIZER_START"] = "auto-resizer-start";
  FRAME["AUTO_RESIZER_STOP"] = "auto-resizer-stop";
...
function () {
  ...
  Frame.prototype.getHeight = function () {
    var doc = this.win.document.querySelector('html');
...
function (_super) {
  ...
  function ClientConnection(options) {
    ...
    if (_this.options.connectionTimeout !== false) {
      _this.connectionTimeout = window.setTimeout(function () {
        _this.handleMessage({
          type: MESSAGE_TYPE.EMIT,
          event: MIO_EVENTS.CONNECTION_TIMEOUT
        });
      }, Number(_this.options.connectionTimeout));
    }
  ...
  ClientConnection.prototype.init = function () {
    ...
    var name = url.searchParams.get('mio-name');
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            e_1 = _a.sent();
            throw new Error("This normally means you're calling get form model in a context where it's not created");
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        ...
                        return [4
                        /*yield*/
                        , this.setupContext(resolve, reject)];
  ...
  SDK.prototype.requestContext = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [2
        /*return*/
        , this.connection.request(CONTEXT.GET)];
      });
    });
  };
...
},{}],"src/service/product-search-service.js":[function(require,module,exports) {
"use strict";
...
onInit();
},{"dc-extensions-sdk":"node_modules/dc-extensions-sdk/dist/dc-extensions-sdk.es5.js","./src/service/product-search-service.js":"src/service/product-search-service.js"}],"../../../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
